...
import CalculatorIcon from '~/icons/calculator.svg?react'
...
import MyInvitationsIcon from '~/icons/my-invitations.svg?react'
...
const Icons = {
  ...
  ArrowLineRightIcon,
  ArrowLineUpIcon,
  ArrowLineDoubleLeftIcon,
  ArrowLineDoubleRightIcon,
  ArrowRightIcon,
  BetIcon,
  CalculatorIcon,
  CatEarIcon,
