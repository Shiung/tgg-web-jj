const responsibleGamblingInfo = {
  trigger: 'Responsible Gambling',
  title: 'Gambling Awareness and Protecting Minors',
  sections: [
    {
      title: '',
      content: [
        `
          Betting in online casinos is primarily for entertainment purposes. However, a small percentage of people lose control when gambling. Before you start playing games, it's important to understand that gaming should not be viewed as a source of income or a means to pay off debt. It is beneficial to keep track of the time and money spent at online casinos on a daily basis. OK fun only accepts players over the age of 18 and uses all applicable methods to prevent minors from registering and playing at our casino. The casino reserves the right to require players to provide proof of identity and will deny access to the site if the player is under the legal gambling age. However, we recognize that due to the widespread availability of the Internet, persons under the age of 18 may still register and play at online casinos. Therefore, we strongly encourage parents to work together to protect their children from visiting gambling sites. There is specialized software that can help with this situation. For more information, please visit the websites listed below.
  ...
  sections: [
    {
      ...
      content: [
        ...
        'The website Bitstarz operated by Dama N.V., a company registered and established under the laws of Curaçao, with registration number 152125 and registered address at Scharlooweg 39, Willemstad, Curaçao. Dama N.V. is licensed and regulated by the Curaçao Gaming Control Board (license no.OGL/2023/174/0082).',
        'If you have any other questions regarding this Privacy Policy or protection of your data, please feel free to contact our Data Protection Officer at （填入客服联系方式）',
    ...
    },
    {
      ...
      content: [
        ...
        'Whenever you decide to stop receiving such marketing and advertising material, you may opt out of this in your Player Account settings or by contacting our customer support at （填入客服联系方式）.',
    ...
    {
      title: 'Obtaining Personal Information',
      content: [
        ...
        'Please understand that we may be granted access to any information you may provide to such vendors, service providers and third-party e-commerce services. Rest assured that we will use and safeguard any Personal Information so obtained, as set out in this Policy.',
      ],
    },
    {
    ...
    {
      title: 'Releasing Data to Third Parties',
      content: [
    ...
    },
    {
      ...
      content: [
        'As stated under our Terms and Conditions both, you and the Casino can decide to have your Player Account closed at any time. Following closure of your account, we will retain your personal data on record for as long as required by law.',
    ...
    },
    {
      ...
      content: [
        ...
        'Player Accounts can only be accessed with the player’s unique ID and password. You may also set up two-factor authentication (2FA) as additional protection from unauthorised use of your account.',
      ],
    },
    {
      title: 'Your Rights',
      content: [
        ...
        'Request the erasure of your personal data: You may request the erasure of your personal data where we no longer have a legal basis to continue processing it or retaining it;',
        'Object to the processing of your personal data where we rely on our legitimate interests to process your data and you feel that our processing of your data in such a manner impacts your fundamental rights and freedoms.',
        'Request the restriction of the processing of your personal data: You may ask us to temporarily suspend the processing of your personal data in specific scenarios;',
        'Request the transfer of your personal data (i.e. data portability): You may request us to provide you with certain data we process about you so you may transfer it to another controller;',
    ...
    },
    {
      ...
      content: [
        ...
        'We have appointed a data protection officer (“DPO”) who is responsible for overseeing questions in relation to this privacy policy. If you have any questions about this privacy policy, please contact the DPO at （填入客服联系方式）.',
...
export default { responsibleGamblingInfo, privacyPolicyInfo }
